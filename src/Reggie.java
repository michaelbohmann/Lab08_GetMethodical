...
public class Reggie {
    public static void main(String[] args) {
        ...
        String ssn = SafeInput.getRegExString(in, "Enter your SSN (format: 123-45-6789)", "^\\d{3}-\\d{2}-\\d{4}$");
        System.out.println("You entered SSN: " + ssn);


        String mNumber = SafeInput.getRegExString(in, "Enter your UC Student M number (format: M12345)", "^(M|m)\\d{5}$");
