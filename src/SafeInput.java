...
public class SafeInput {
    ...
    /**
     * get a String value that matches a regular expression
     *
     * @param pipe   scanner to use to read the input
     * @param prompt prompt to tell the user what to input
     * @return regEx String - regular expression pattern to match
     */
    public static String getRegExString(Scanner pipe, String prompt, String regEx) {
        ...
        do {
            ...
            if (retVal.matches(regEx)) {
                ...
                System.out.println("You must enter a valid regular expression " + regEx);
            }
    ...
    public static void prettyHeader(String msg) {
        ...
        int sideAsterisks = 3;
        int availableSpace = totalLineWidth - (sideAsterisks * 2);
